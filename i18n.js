...
const translations = {
  es: {
    ...
    's1.allProjects':    'Todos los proyectos',
    's2.editing':        '✏️ Editando',
    's2.update':         '💾 Actualizar QR',
    's2.newLabel':       '',
    ...
    'auth.saveProfile':  'Guardar',
    'auth.displayName':  'Nombre',
    'auth.emailLabel':   'Email',
    'auth.email.ph':     'tu@email.com',
    'auth.pass.ph':      'Contraseña',
    'auth.pass.reg.ph':  'Contraseña (mín. 6 caracteres)',
    'auth.name.ph':      'Tu nombre',
    'auth.anonLimit':    'Iniciá sesión para crear más proyectos y poder editarlos.',
    // viewer
  ...
  en: {
    ...
    's1.allProjects':    'All projects',
    's2.editing':        '✏️ Editing',
    's2.update':         '💾 Update QR',
    's2.newLabel':       '',
    'auth.signin':       'Sign in',
    ...
    'auth.pass.reg.ph':  'Password (min. 6 characters)',
    'auth.name.ph':      'Your name',
    'auth.anonLimit':    'Sign in to create more projects and edit them.',
    // viewer
  ...
  pt: {
    ...
    's1.allProjects':    'Todos os projetos',
    's2.editing':        '✏️ Editando',
    's2.update':         '💾 Atualizar QR',
    's2.newLabel':       '',
    'auth.signin':       'Entrar',
    'auth.signout':      'Sair',
    ...
    'auth.changePhoto':  'Trocar foto',
    'auth.saveProfile':  'Salvar',
    'auth.displayName':  'Nome',
    'auth.emailLabel':   'E-mail',
    'auth.email.ph':     'voce@email.com',
    'auth.pass.ph':      'Senha',
    'auth.pass.reg.ph':  'Senha (mín. 6 caracteres)',
    'auth.name.ph':      'Seu nome',
    'auth.anonLimit':    'Entre para criar mais projetos e poder editá-los.',
    // viewer
